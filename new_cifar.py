...
PERTURBATIONS = ['brightness', 'gaussian_blur', 'gaussian_noise','gaussian_noise_2',
                 'gaussian_noise_3','motion_blur','rotate','scale','shear','shot_noise',
                 'shot_noise_2','shot_noise_3','snow','spatter','speckle_noise',
